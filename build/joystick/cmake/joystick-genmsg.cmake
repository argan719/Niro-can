...
set(MSG_I_FLAGS "-Ijoystick:/home/ubuntu/catkin_ws/src/joystick/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/ubuntu/catkin_ws/src/joystick/msg/control_msg.msg" NAME_WE)
add_custom_target(_joystick_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "joystick" "/home/ubuntu/catkin_ws/src/joystick/msg/control_msg.msg" ""
)
...
_generate_msg_cpp(joystick
  "/home/ubuntu/catkin_ws/src/joystick/msg/control_msg.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/joystick)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/joystick\")")
  # install generated code
  install(
